            ...
            <div>
                ...
                <div className="row">
                    <div className="col-md-6 d-flex juastify-content-center align-items-center">
                        <img src={profile} alt="" className='mx-auto p-5 rounded' style={{ maxWidth: '100%', maxHeight: '500px' }} />
                    </div>
                    <div className="col-md-6 d-flex align-items-center">
                        <h3 className='color-5 px-5 py-md-5 py-0 profile-details'> I am Asadujjaman Mridul. <br /><br />
